...
- Hermes `1.2.5` is the upload-session release candidate: file workflows can release abandoned upload sessions while preserving idempotent retries.
...
| --- | --- | --- |
| Hermes | `hermes/reman-agentic` | `1.2.4` published; `1.2.5` upload-session release candidate |
