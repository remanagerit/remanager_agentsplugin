...
- Hermes `1.2.4` is the currently published Accounting release.
- Hermes `1.2.6` is the upload-diagnostics release candidate: file workflows preserve Core quota/rate diagnostics and can release abandoned upload sessions while preserving idempotent retries.
...
| --- | --- | --- |
| Hermes | `hermes/reman-agentic` | `1.2.5` published; `1.2.6` upload-diagnostics release candidate |
