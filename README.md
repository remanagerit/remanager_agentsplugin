...
- Hermes `1.2.2` is the reusable document-access candidate: 37 bounded reads and 53 actions fixed to `draft_with_confirmation`, including separate document view and original-file URLs reusable until their maximum three-hour expiry.
...
| --- | --- | --- |
| Hermes | `hermes/reman-agentic` | `1.2.1` published; `1.2.2` reusable document-access candidate |
