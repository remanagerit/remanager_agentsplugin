...
- Hermes `1.2.8` is the currently published Accounting release candidate for tax-installment attachment channels: file workflows can target generic installment attachments, payment forms or receipts through `attachmentRole`.
...
| --- | --- | --- |
| Hermes | `hermes/reman-agentic` | `1.2.8` tax-installment attachment channels release candidate |
