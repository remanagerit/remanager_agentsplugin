...
DRAFT_CONTRACTS = {
    ...
    "accounting.documents.create": _contract("draft_with_confirmation", ("companyId", "type"), ("projectId", "crmContactId") + DOCUMENT_FIELDS, "type: invoice_in|invoice_out|invoice_notice_in|invoice_non_electronic_in|other_expense|credit_note|debit_note|other"),
    ...
    "accounting.tax_commitments.create": _contract("draft_with_confirmation", ("companyId", "title", "commitmentType", "totalAmount", "installmentCount"), ("taxCode", "compensable", "status", "notes"), "commitmentType: f24|f23|pagopa|bollettino|avviso_bonario|cartella|other"),
    ...
    "accounting.non_electronic_invoices.create": {
        ...
        "optional": ["accounting_contact_id", "partner_name", "partner_tax_code", "partner_vat_number", "due_date", "withholding_amount", "original_currency", "original_net_amount", "original_vat_amount", "original_gross_amount", "fx_rate_to_eur", "fx_rate_date", "fx_rate_source", "fx_conversion_note", "description", "notes"],
